...
export default {
    "acceptance_rate":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.batchQuantity'),field:"total"},{label:i18n.t('statistical.approvalBatchNumber'),field:"pass"},{label:i18n.t('statistical.approvalRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.batchQuantity'),field:"total"},{label:i18n.t('statistical.approvalBatchNumber'),field:"pass"},{label:i18n.t('statistical.approvalRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
    ...
    "return_rate":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.batchQuantity'),field:"total"},{label:i18n.t('statistical.rejectsBatchNumber'),field:"return"},{label:i18n.t('statistical.rejectsRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.batchQuantity'),field:"total"},{label:i18n.t('statistical.rejectsBatchNumber'),field:"return"},{label:i18n.t('statistical.rejectsRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
    ...
    "bad_rate":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.inspectionQuantity'),field:"total"},{label:i18n.t('statistical.badQuantity'),field:"bad"},{label:i18n.t('statistical.badRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.inspectionQuantity'),field:"total"},{label:i18n.t('statistical.badQuantity'),field:"bad"},{label:i18n.t('statistical.badRate')+"(%)",field:"rate"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
    ...
    "abnormal_count":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.inspectionQuantity'),field:"total"},{label:i18n.t('statistical.abnormalQuantity2'),field:"count"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"rate"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.inspectionQuantity'),field:"total"},{label:i18n.t('statistical.abnormalQuantity2'),field:"count"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"rate"}],
    ...
    "first_pass_yield":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.inputQuantity'),field:"count"},{label:i18n.t('statistical.badQuantity'),field:"bad"},{label:i18n.t('statistical.passRate')+"(%)",field:"fpy"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.inputQuantity'),field:"count"},{label:i18n.t('statistical.badQuantity'),field:"bad"},{label:i18n.t('statistical.passRate')+"(%)",field:"fpy"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
    ...
    "customer_complaint_count":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.complaintQuantity'),field:"count"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.complaintQuantity'),field:"count"},{label:i18n.t('statistical.totalProportion')+"(%)",field:"totalProportion"}],
    ...
    pieColorList: [
      "#018bd6","#4cd701","#ff9c1b","#f75c48","#ea2b8b"
    ]
