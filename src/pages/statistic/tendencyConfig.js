...
export default {
    ...
    "defect":{
        columns:[{label:i18n.t('statistical.name'),field:"name"},{label:i18n.t('statistical.sampleQunatity'),field:"total"},{label:i18n.t('statistical.defectDataSelect'),field:"count"},{label:i18n.t('statistical.defectRate')+"(%)",field:"rate"}],
        columnss:[{label:i18n.t('statistical.productNo'),field:"name"},{label:i18n.t('statistical.productSpec'),field:"prodSpec"},{label:i18n.t('statistical.sampleQunatity'),field:"total"},{label:i18n.t('statistical.defectDataSelect'),field:"count"},{label:i18n.t('statistical.defectRate')+"(%)",field:"rate"}],
        title : i18n.t('statistical.defectDataSelect'),
        reportTitle : i18n.t('statistical.defectDataSelect'),
        seriesName:i18n.t('statistical.defectDataSelect'),
        valueField:"count",
        okTxt : "",
        collect: function(rows){
            var totalItem = {label:i18n.t('statistical.sampleTotal'),value:0};
            var totalysItem = {label:i18n.t('statistical.defectTotal'),value:0};
            var overallRate = {label:i18n.t('statistical.defectRateTotal'),value:0}
            var total = 0;
            var total_pass = 0;
            var rate = 0;
            if(rows){
                ...
                let a = total_pass / total*100 //百分数
                let b = Math.floor(a*100) / 100
                /* alert(b+'---'+'xx')
                let num = total_pass/total*100.0
                rate = numeral(num).format('0.00');
                alert(rate,'rate') */
            ...
            return [totalItem,totalysItem,overallRate];
        }
    },
    ...
    buzNameMap: {
          ...
          defect:i18n.t('statistical.defectQuantity2')
    },
    buzParams : {
          'iqc': {
    ...
    ["#4fa8f9", "#6ec71e", "#f56e6a", "#fc8b40", "#818af8", "#31c9d7", "#f35e7a", "#ab7aee", "#14d68b", "#edb00d"],
